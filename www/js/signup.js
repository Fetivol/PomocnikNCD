(function () {
  ...
  btnSignup.addEventListener("click", (e) => {
    ...
    if (txtUserEmail.value == "") {
      ...
      if (
        ...
        $("#txtUserEmail")
          .parent()
          .attr("data-validate", "Invalid format")
          .addClass("alert-validate");
      } else {
        complite++;
      }
    ...
    if (txtUserPass.value == "") {
      ...
      if (txtUserPass.value.length < 6) {
        $("#txtUserPass")
          .parent()
          .attr("data-validate", "Min 6 characters")
          .addClass("alert-validate");
      } else {
        complite++;
      }
    ...
    if (txtUserPass2.value == "") {
      ...
      if (txtUserPass.value === txtUserPass2.value) {
        complite++;
      } else {
        $("#txtUserPass2")
          .parent()
          .attr("data-validate", "Not match")
          .addClass("alert-validate");
      }
    }
    ...
    if (complite == 3) {
      ...
      promis.catch(function (e) {
        ...
        if (
          ...
          $("#txtUserEmail")
            .parent()
            .attr("data-validate", "Email is taken")
            .addClass("alert-validate");
        }
  ...
  btnRegDone.addEventListener("click", (e) => {
    ...
    if (userLoadPhoto == 1) {
      var photoUrl = document.getElementById("myImg").src;
